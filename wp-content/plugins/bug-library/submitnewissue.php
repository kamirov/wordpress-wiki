...
<?php
	...
	{
		if ($_POST['new-bug-title'] != '' && ( ( isset( $_POST['new-bug-version'] ) && $_POST['new-bug-version'] != '' ) || $genoptions['hideversionnumber'] ) && $_POST['new-bug-desc'] != '' && (($genoptions['requirename'] == false) || ($genoptions['requirename'] == true && $_POST['new-bug-reporter-name'] != '') && ($genoptions['requireemail'] == false || ($genoptions['requireemail'] == true && $_POST['new-bug-reporter-email'] != ''))))
		{
